...
CREATE POLICY "Allow Edge Functions to insert runs" ON "public"."runs" FOR INSERT TO "service_role" WITH CHECK (true);

CREATE POLICY "Allow Edge Functions to update runs" ON "public"."runs" FOR UPDATE TO "service_role" USING (true);
